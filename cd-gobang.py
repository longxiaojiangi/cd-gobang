...
def satrtGUI(ch):
    pygame.init()
    bg = r'C:\Users\longxiaojiangi\Desktop\cd-gobang\images\bg.png'
    white_image = r'C:\Users\longxiaojiangi\Desktop\cd-gobang\images\white.png'
    black_image = r'C:\Users\longxiaojiangi\Desktop\cd-gobang\images\black.png'

    pygame.display.set_caption("猫狗五子棋1.0")
            ...
            if event.type == QUIT:
                ...
                if 25 <= x <= 725 and 25 <= y <= 725 and ((x - 25) % 50 <= level or (x - 25) % 50 >= 0) and (
                    ...
                    if Judge(m, n, color, ch.a, 4):
                        screen.blit(font.render('游戏结束，黑棋胜！', True, (110, 210, 30)), (80, 650))
                        break
                    ...
                    if Judge(x, y, color, ch.a, 4):
                        screen.blit(font.render('游戏结束，白棋胜！', True, (217, 20, 30)), (80, 650))
                        break
